...
supports the following packet formats:
 ...
 - [[https://relishapp.com/trema/pio/docs/icmp][ICMP]]
 - [[https://relishapp.com/trema/pio/docs/arp][ARP]]
 - LLDP
 - DHCP
 - OpenFlow 1.0
   - Hello
 ...
 - OpenFlow 1.3
   ...
   - [[https://relishapp.com/trema/pio/docs/openflow-1-3-echo-request-message][Echo Request]]
   - [[https://relishapp.com/trema/pio/docs/openflow-1-3-echo-reply-message][Echo Reply]]
