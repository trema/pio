Feature: Features Reply
  Scenario: create
    When I try to create an OpenFlow message with:
      ...
      Pio::Features::Reply.new(
        ...
        actions: [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan,
                  :set_dl_source, :set_dl_destination, :set_nw_source, :set_nw_destination,
    ...
    And the message have the following fields and values:
      ...
      | actions                      | [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan, :set_dl_source, :set_dl_destination, :set_nw_source, :set_nw_destination, :set_nw_tos, :set_tp_source, :set_tp_destination, :enqueue] |
      | ports.length                 |                                                                                                                                                                                          1 |
