Feature: Features Reply
  Scenario: create
    ...
    And the message have the following fields and values:
      ...
      | actions                      | [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan, :set_dl_source, :set_dl_destination, :set_ip_source_address, :set_ip_destination_address, :set_ip_tos, :set_transport_source_port, :set_transport_destination_port, :enqueue] |
      | ports.length                 |                                                                                                                                                                                                                                  1 |
