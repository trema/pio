...
Feature: Pio::Features::Reply
  ...
  Scenario: read
    ...
    And the message has the following fields and values:
      ...
      | actions                   | [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan, :set_ether_source_address, :set_ether_destination_address, :set_ip_source_address, :set_ip_destination_address, :set_tos, :set_transport_source_port, :set_transport_destination_port, :enqueue] |
      | ports.length              | 3                                                                                                                                                                                                                                                     |
