Feature: Features Reply
  Scenario: create
    When I try to create an OpenFlow message with:
      ...
      Pio::Features::Reply.new(
        ...
        actions: [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan,
                  :set_dl_source, :set_dl_dst, :set_nw_source, :set_nw_dst,
                  :set_nw_tos, :set_tp_source, :set_tp_dst, :enqueue],
        ports: [{ port_no: 1,
    ...
    And the message have the following fields and values:
      ...
      | actions                      | [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan, :set_dl_source, :set_dl_dst, :set_nw_source, :set_nw_dst, :set_nw_tos, :set_tp_source, :set_tp_dst, :enqueue] |
      | ports.length                 |                                                                                                                                                                  1 |
