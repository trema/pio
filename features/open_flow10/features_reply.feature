Feature: Features Reply
  Scenario: create
    When I try to create an OpenFlow message with:
      ...
      Pio::Features::Reply.new(
        ...
        actions: [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan,
                  ...
                  :set_ip_tos, :set_transport_source_port, :set_tp_destination, :enqueue],
        ports: [{ port_no: 1,
    ...
    And the message have the following fields and values:
      ...
      | actions                      | [:output, :set_vlan_vid, :set_vlan_pcp, :strip_vlan, :set_dl_source, :set_dl_destination, :set_ip_source_address, :set_ip_destination_address, :set_ip_tos, :set_transport_source_port, :set_tp_destination, :enqueue] |
      | ports.length                 |                                                                                                                                                                                                                      1 |
