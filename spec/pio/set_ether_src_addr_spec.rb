...
describe Pio::SetEtherSrcAddr do
  describe '.new' do
    Given(:set_ether_src_addr) do
      Pio::SetEtherSrcAddr.new(mac_address)
    end

    context "with '11:22:33:44:55:66'" do
      When(:mac_address) { '11:22:33:44:55:66' }
      Then { set_ether_src_addr.mac_address == '11:22:33:44:55:66' }

      describe '#to_binary' do
        Then { set_ether_src_addr.to_binary.length == 16 }
      end
    end
